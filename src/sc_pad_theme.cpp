...
const Theme kThemes[kThemeCount] = {
    // RSI
    {
        ...
        0x080B0D,                   // screen 屏幕背景色
        0x11171A,                   // header 顶部状态栏底色
        0x151B1D,                   // surface 按钮/卡片底色
        0x2A3438,                   // surface_pressed 按钮按下底色
        0x4A565A,                   // border 边框颜色
        0x0E1315,                   // nav 底部导航栏底色
        0xF4F3EE,                   // text 主文字颜色
        ...
        0xF2A93B,                   // progress_border 过渡闪烁色
    ...
    // AEGIS
    {
        ...
        0x0C0D0F,           // screen 屏幕背景色
        0x141317,           // header 顶部状态栏底色
        0x1A1B1E,           // surface 按钮/卡片底色
        0x303238,           // surface_pressed 按钮按下底色
        ...
        0xF0B84F,           // progress_border 过渡闪烁色
    ...
    // ANVIL
    {
        ...
        0x383A31,           // surface_pressed 按钮按下底色
        ...
        0xE1B849,           // progress_border 过渡闪烁色
    ...
    // DRAKE
    {
        ...
        0x4A321D,               // surface_pressed 按钮按下底色
        ...
        0xF4C542,               // progress_border 过渡闪烁色
    ...
    // MISC
    {
        ...
        0xDCE9EC,          // surface_pressed 按钮按下底色
    ...
    // ORIGIN
    {
        ...
        0xEEE6DB,            // surface_pressed 按钮按下底色
        ...
        0x6A8495,            // progress_border 过渡闪烁色
    ...
    // CRUSADER
    {
        ...
        0x14384C,              // surface_pressed 按钮按下底色
        ...
        0xC49AFF,              // progress_border 过渡闪烁色
